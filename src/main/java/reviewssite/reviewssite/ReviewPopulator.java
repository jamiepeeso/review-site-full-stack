...
public class ReviewPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Review superman = new Review("Superman", "Clark Kent, Kal-El", "images/dc/superman_00s.jpg", DC,
		...
		Review batman = new Review("Batman", "Bruce Wayne", "images/dc/batman_im_batman.jpg", DC,
		...
		Review wonderwoman = new Review("Wonder Woman", "Diana Prince", "images/dc/wonderwoman_00s.jpg", DC,
		...
		Review daredevil = new Review("Daredevil", "Matthew Michael Murdock", "images/marvel/daredevil.jpg", Marvel,
		...
		Review starLord = new Review("Star Lord", "Peter Jason Quill", "images/marvel/star_lord_gun_up.jpg", Marvel,
		...
		Review drStrange = new Review("Doctor Strange", "Stephen Vincent Strange",
